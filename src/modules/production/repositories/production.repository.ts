...
// export async function createProductionRepo(dto: CreateProductionDto): Promise<IProduction> {
...
// export async function findProductionById(id: string): Promise<IProduction | null> {
//     return await Production.findById(id).populate('managerId', 'fullName email department');
// }

// export async function findAllProductions(filter: any, skip: number, limit: number): Promise<{ productions: IProduction[]; total: number }> {
...
// export async function updateProductionRepo(id: string, dto: UpdateProductionDto): Promise<IProduction | null> {
...
// export async function deleteProductionRepo(id: string): Promise<IProduction | null> {
//     return await Production.findByIdAndDelete(id);
// }

// export async function findTodayProduction(): Promise<IProduction[]> {
...
// export async function countProductions(filter: any = {}): Promise<number> {
//     return await Production.countDocuments(filter);
// }

// export async function aggregateProductionStats(filter: any = {}) {
...
// export async function aggregateTodayProductionStats() {
//     const startOfDay = new Date();
//     startOfDay.setHours(0, 0, 0, 0);
//     const endOfDay = new Date();
//     endOfDay.setHours(23, 59, 59, 999);
...
//     create: createProductionRepo,
//     findById: findProductionById,
//     findAll: findAllProductions,
//     update: updateProductionRepo,
//     delete: deleteProductionRepo,
//     findTodayProduction,
//     count: countProductions,
//     aggregateStats: aggregateProductionStats,
//     aggregateTodayStats: aggregateTodayProductionStats,
// };
import Production, { IProduction } from '../models/production.model';
import {
    CreateProductionDto,
    UpdateProductionDto,
} from '../../user/dto/admin.dto';

export async function createProductionRepo(
...
export async function findProductionById(
    id: string
...
export async function findAllProductions(
    filter: any,
    skip: number,
    limit: number
): Promise<{
...
export async function aggregateTodayStats() {
    const startOfDay = new Date();
    startOfDay.setHours(0, 0, 0, 0);
