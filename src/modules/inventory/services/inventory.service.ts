...
export async function getFabrics(query: any = {}) {
...
export async function createFabric(data: Partial<IFabricItem>, userName: string = 'Admin') {
...
export async function updateFabric(id: string, data: Partial<IFabricItem>, userName: string = 'Admin') {
...
export async function deleteFabric(id: string, userName: string = 'Admin') {
...
export async function getThreads(query: any = {}) {
    const page = parseInt(query.page || '1', 10);
    const limit = parseInt(query.limit || '10', 10);
    const skip = (page - 1) * limit;
...
export async function createThread(data: Partial<IThreadItem>, userName: string = 'Admin') {
...
export async function updateThread(id: string, data: Partial<IThreadItem>, userName: string = 'Admin') {
...
export async function deleteThread(id: string, userName: string = 'Admin') {
...
export async function getGarments(query: any = {}) {
    const page = parseInt(query.page || '1', 10);
    const limit = parseInt(query.limit || '10', 10);
    const skip = (page - 1) * limit;
...
export async function createGarment(data: Partial<IGarmentItem>, userName: string = 'Admin') {
...
export async function updateGarment(id: string, data: Partial<IGarmentItem>, userName: string = 'Admin') {
...
export async function deleteGarment(id: string, userName: string = 'Admin') {
