...
export async function getEmployeePerformance(userId: string): Promise<EmployeePerformanceData> {
...
export async function getTeamPerformance(): Promise<{
    ...
    const perfPromises = employees.map((emp) => getEmployeePerformance(emp._id.toString()));
