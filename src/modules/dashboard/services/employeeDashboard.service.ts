...
import * as salaryService from '../../salary/services/salary.service';
import * as attendanceService from '../../attendance/services/attendance.service';
...
export async function getSalarySummary(userId?: string) {
