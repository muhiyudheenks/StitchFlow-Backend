...
export async function getSalaryOverview(userId?: string): Promise<SalaryOverviewData> {
...
export async function generatePayslipPdf(payrollId: string): Promise<{ filename: string; content: string }> {
